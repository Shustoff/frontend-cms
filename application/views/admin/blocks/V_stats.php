<h3 class="center">Статистика сайта</h3>
    <div class="row">
        <div class="span4 offset1">
            ...
            <div class="control-group">
                <label class="control-label">Всего ролей</label>
                <div class="controls">
                    <span class="uneditable-input"><?=$roles;?></span>
                </div>
            </div>
        </div>
        <div class="span4">
            ...
            <div class="control-group">
                <label class="control-label">Самый активный пользователь</label>
                <div class="controls">
                    <span class="uneditable-input"><?=$mostactive;?></span>
                </div>
            </div>
        </div>
    </div>
