...
# Схема: frontend
# Время создания: 2012-07-10 15:48:25 +0000
# ************************************************************
...
VALUES
	...
	(5,'Каталог номер 4','catalog4','Описание каталога номер 4',1,'2012-06-14',1,0),
	(6,'Каталог номер 5','catalog5','Описание каталога номер 5',2,'2012-06-14',1,0),
...
INSERT INTO `options` (`id`, `sitename`, `description`, `keywords`, `robots`, `email`, `email_from`, `copyright`, `page404`, `status`, `htaccess`, `debug`, `cache`, `session`)
VALUES
	(1,'Названиеf','Описание сайта ','ключевые, слова, тут',0,'admin@example.ru','Вася Пупкин','Все права никому не принадлежат.','Запрошенная вами страница на существует.',1,1,1,1,65);
...
VALUES
	(1,'int3rhard@gmail.com','admin','ac6f6788b30fa58d5fbddad35140bad44b0ce132dec42bf54f160f1ac451722d','Dima','Dimich','2012-06-28',1,108,'0000-00-00',0),
