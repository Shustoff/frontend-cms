...
# Схема: frontend
# Время создания: 2012-07-31 17:21:19 +0000
# ************************************************************
...
VALUES
	(1,'Каталог номер 1','catalog','<p>Описание каталога номер 1</p>\n',0,'2012-06-20',1,0),
...
VALUES
	(1,'Это название сайта','Это описание сайта','ключевые, слова, словечки, ключевики, ключики','index,follow','admin@example.ru','Вася Пупкин','Все права никому не принадлежат.','Запрошенная вами страница на существует.',1,1,1,65);
...
VALUES
	(1,'int3rhard@gmail.com','admin','ac6f6788b30fa58d5fbddad35140bad44b0ce132dec42bf54f160f1ac451722d','Dima','Dimich','2012-06-28',1,116,'0000-00-00',0),
