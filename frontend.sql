...
INSERT INTO `catalogs` (`id`, `catname`, `alias`, `content`, `parent_id`, `date`, `status`, `intrash`) VALUES
	(1, 'Каталог номер 1', 'catalog1', '<p>\n	Описание каталога номер 1</p>\n', 0, '2012-06-20', 1, 0),
...
INSERT INTO `modules` (`id`, `name`, `systemname`, `content`, `author_id`, `type`, `date`, `status`, `intrash`) VALUES
	(2, 'Модуль навигации', 'navigation', '<p>\n	Описание модуля</p>\n', 1, 'HTML', '2012-06-16', 1, 0),
...
-- Dumping data for table frontend.pages: 18 rows
DELETE FROM `pages`;
...
INSERT INTO `users` (`id`, `email`, `username`, `password`, `firstname`, `lastname`, `datereg`, `status`, `logins`, `last_login`, `intrash`) VALUES
	(1, 'int3rhard@gmail.com', 'admin', 'ac6f6788b30fa58d5fbddad35140bad44b0ce132dec42bf54f160f1ac451722d', 'Dima', 'Dimich', '2012-06-28', 1, 256, '0000-00-00', 0),
